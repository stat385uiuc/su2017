#### Taken from Yihui's Website
## Version: https://github.com/rbind/yihui/blob/3f00d8c4da982cf78df9e1eab3e48620387e1058/R/build.R
## Live: https://github.com/rbind/yihui/blob/master/R/build.R
##
...
if (length(rmds)) {
  ...
  files = cbind(rmds, blogdown:::with_ext(rmds, '.md'), FALSE) 
}
