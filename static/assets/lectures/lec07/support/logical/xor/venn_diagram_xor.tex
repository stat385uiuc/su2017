...
\begin{document}
      ...
      \begin{tikzpicture}
            ...
            \draw[outline, filled, even odd rule] \firstduocircle node {$X$} \secondduocircle node {$Y$};
            \draw[thick] (-1.75,-2.50) rectangle (3.75,2.45) node [below left] {$S$};
            \draw[line] (-1.75,-3.25) -- (3.75,-3.25);
              \node[text=red] at (1,-3) {Area of $\overline{X \cap Y}$ is the same as $XOR\left({X, Y}\right)$};
      \end{tikzpicture}
